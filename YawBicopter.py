...
if __name__ == "__main__":
    ...
    # // PID terms
    serial.send_preference(ROBOT_MAC, DataType_Float, "kpyaw", 3) #2
    serial.send_preference(ROBOT_MAC, DataType_Float, "kdyaw", -.3)#.1
    serial.send_preference(ROBOT_MAC, DataType_Float, "kiyaw", 0)

    serial.send_preference(ROBOT_MAC, DataType_Float, "kpz", 3)
    serial.send_preference(ROBOT_MAC, DataType_Float, "kdz", 1.6)
    serial.send_preference(ROBOT_MAC, DataType_Float, "kiz", .1)
    ...
    try:
        while True:
            ...
            temp += -axis[0]
            fz = temp # Vertical left joystick
